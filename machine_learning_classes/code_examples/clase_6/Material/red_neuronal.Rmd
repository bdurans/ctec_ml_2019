...
main = 'Distribuciones de V8 Normalizado',
ylab = 'V8',
xlab = 'Tarjeta aceptada')
```
...
crx.fit <- neuralnet(V16yes ~ V1b+V2 ,data = m2,hidden =4,rep=1,linear.output=T)
```
...
predicciones.red <- neuralnet::compute(crx.fit,mp2[,c("V1b","V2")])

results <- data.frame(actual = mp2, prediction = predicciones.red$net.result)
results
